...
int blc_eatt_registerService(u8 srvCount, u8 chCount, u16 mtu, u16 mps, u16 credits, u8 *pBuffer,
...
int blc_eatt_sendReadByTypeReq(u16 connHandle, u16 scid, u16 startAttHandle, u16 endAttHandle, u8 *uuid, int uuidLen);
int blc_eatt_sendReadByTypeRsp(u16 connHandle, u16 scid, u8 typeLen, u8 dataLen, u8 *pData);

int blc_eatt_sendReadByGroupTypeReq(u16 connHandle, u16 scid, u16 startAttHandle, u16 endAttHandle, u8 *uuid,
                                    int uuidLen);
...
int blc_eatt_sendFindByTypeReq(u16 connHandle, u16 scid, u16 startAttHandle, u16 endAttHandle, u8 *pUuid,
                               u8 *pAttrValue, int valueLen);
...
int blc_eatt_sendPrepareWriteReq(u16 connHandle, u16 scid, u16 attHandle, u16 offset, u16 dataLen, u8 *pData);
int blc_eatt_sendPrepareWriteRsp(u16 connHandle, u16 scid, u16 attHandle, u16 offset, u16 dataLen, u8 *pData);
