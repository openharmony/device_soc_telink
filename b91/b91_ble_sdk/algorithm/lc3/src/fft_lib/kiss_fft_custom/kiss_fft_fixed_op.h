...
#define C_MUL_32_16(m, a, b)                                                                                          \
    do {                                                                                                              \
        (m).r = (__nds__kmmwb2_u((a).r, (b).r) - __nds__kmmwb2_u((a).i, (b).i));                                      \
        (m).i = (__nds__kmmwb2_u((a).r, (b).i) + __nds__kmmwb2_u((a).i, (b).r));                                      \
    } while (0)

#else
#define C_MUL_32_16(m, a, b)                                                                                          \
    do {                                                                                                              \
        (m).r = (sround32(smul32((a).r, (b).r)) - sround32(smul32((a).i, (b).i)));                                    \
        (m).i = (sround32(smul32((a).r, (b).i)) + sround32(smul32((a).i, (b).r)));                                    \
    } while (0)
#endif
...
#define DIVSCALAR(x, k) (x) = sround(smul(x, 32767 / k))
...
#define C_MULBYSCALAR_32(c, s)                                                                                        \
    do {                                                                                                              \
        (c).r = (__nds__kmmwb2_u((c).r, s));                                                                          \
        (c).i = (__nds__kmmwb2_u((c).i, s));                                                                          \
    } while (0)
#else
#define C_MULBYSCALAR_32(c, s)                                                                                        \
    do {                                                                                                              \
        (c).r = sround32(smul32((c).r, s));                                                                           \
        (c).i = sround32(smul32((c).i, s));                                                                           \
    } while (0)
#endif
...
#define C_ADD_HALF(res, a, b)                                                                                         \
    do {                                                                                                              \
        (res).r = __nds__raddw((a).r, (b).r);                                                                         \
        (res).i = __nds__raddw((a).i, (b).i);                                                                         \
    } while (0)
#define C_SUB_HALF(res, a, b)                                                                                         \
    do {                                                                                                              \
        (res).r = __nds__rsubw((a).r, (b).r);                                                                         \
        (res).i = __nds__rsubw((a).i, (b).i);                                                                         \
    } while (0)
#else
#define C_ADD_HALF(res, a, b)                                                                                         \
    do {                                                                                                              \
        (res).r = ((long long int)(a).r + (b).r) >> 1;                                                                \
        (res).i = ((long long int)(a).i + (b).i) >> 1;                                                                \
    } while (0)
#define C_SUB_HALF(res, a, b)                                                                                         \
    do {                                                                                                              \
        (res).r = ((long long int)(a).r - (b).r) >> 1;                                                                \
