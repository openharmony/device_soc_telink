...
static int ecp_group_load(mbedtls_ecp_group *grp, const mbedtls_mpi_uint *p, size_t plen, const mbedtls_mpi_uint *a,
    ...
    const mbedtls_mpi_uint *gy, size_t gylen, const mbedtls_mpi_uint *n, size_t nlen, const mbedtls_ecp_point *T)
{
...
void mbedtls_ecp_fix_negative(mbedtls_mpi *N, signed char c, size_t bits)
{
    ...
    * negative, this adds c * 2^bits. */
    ...
    if (bits == 224)
        msw <<= 32;
#endif
    N->p[bits / CHAR_BIT / sizeof(mbedtls_mpi_uint)] += msw;
}
...
#define P521_WIDTH (521 / CHAR_BIT / sizeof(mbedtls_mpi_uint) + 1)
...
static int ecp_mod_p521(mbedtls_mpi *N)
{
    ...
    MBEDTLS_MPI_CHK(mbedtls_mpi_shift_r(&M, 521 % (CHAR_BIT * sizeof(mbedtls_mpi_uint))));
